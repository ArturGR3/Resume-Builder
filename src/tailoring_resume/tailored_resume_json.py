...
class Experience(BaseModel):
    ...
    description: List[str] = Field(description="""A list of bullet points describing the work experience tailored to the job description.
                                   Utilize STAR methodology (Situation, Task, Action, Result) implicitly within each bullet point. Make sure to quantify the results if possible.""", min_items=3, max_items=3)
...
def main(resume_path: str, job_description_path: str, model: str):
    ...
    1. Make sure to only use the information provided in the resume. Don't invent any information. If there is is a specific information that might be usefull for the job description, mention it in the nice_to_add field.
...
if __name__ == "__main__":
    ...
    job_description_path = 'JD_Mozilla_Staff Machine Learning Engineer, Gen AI_2024-10-28.json'
